...
export const KEY_QUESTIONS_BY_TRADE = {
  ...
  // Drafts for bricklayer, fencer and tree-surgeon need a trade review before release.
  bricklayer: [
    area('Roughly how much brickwork is involved?', ['Under 5m²', '5–15m²', '15–30m²', 'Over 30m²']),
    { topic: 'type of brickwork', question: 'What kind of brickwork is it?', options: ['New wall', 'Repointing', 'Repairs to an existing wall', 'Extension or structural work'] },
    { topic: 'foundations', question: 'What is the new brickwork being built on?', options: ['Existing footing', 'New foundations needed', 'Nothing new being built'] },
    whoSupplies,
  ],
  fencer: [
    { topic: 'fence length', question: 'Roughly how long is the fence?', options: ['Under 10m', '10–25m', '25–50m', 'Over 50m'] },
    { topic: 'fence type', question: 'What type of fence is it?', options: ['Panels with concrete posts', 'Panels with timber posts', 'Featheredge closeboard', 'Picket or post and rail'] },
    { topic: 'old fence removal', question: 'What happens to the old fence?', options: ['Remove and dispose', 'Customer removes it', 'No old fence'] },
    { topic: 'ground along fence line', question: 'What is the ground like along the fence line?', options: ['Soil or lawn', 'Concrete or paving', 'Sloping ground'] },
  ],
  'tree-surgeon': [
    { topic: 'type of tree work', question: 'What work is needed?', options: ['Crown reduction or thinning', 'Fell the whole tree', 'Hedge cutting', 'Stump grinding'] },
    { topic: 'tree size', question: 'How tall is the tallest tree involved?', options: ['Under 5m', '5–10m', '10–15m', 'Over 15m'] },
    { topic: 'tree access', question: 'How easy is it to work around the tree?', options: ['Open space to drop sections', 'Near buildings or cables, needs rigging', 'Access only through the house'] },
    { topic: 'waste removal', question: 'What happens to the branches and wood?', options: ['Chip and take everything away', 'Leave logs, take the rest', 'Leave everything on site'] },
  ],
}
