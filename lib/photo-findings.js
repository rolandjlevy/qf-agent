// Trader-confirmed photo findings, plus any key questions the trader couldn't answer (with or
// without photos), as sent by /quote/new to Phase A and Phase B. Shared so both prompts match.
const MAX_ITEMS = 12
...
// `unclear` holds only questions the trader was asked and couldn't answer (answered ones
// arrive as ordinary Q&A), so neither phase should ask about them again.
const UNCONFIRMED_NOTE = 'The trader was asked about these before the quote and couldn\'t confirm them'
