...
// Override lets tests point at a throwaway/in-memory DB instead of the
// trader's real data/qf.db — never unset in normal CLI/web usage.
const DB_PATH = process.env.QF_DB_PATH || join(__dirname, '../data/qf.db')
