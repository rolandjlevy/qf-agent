...
export const PLUMBER_JOBS = [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        materials: ['Single lever mixer cartridge 40mm'],
      },
      {
    ...
    pitfalls: [
      ...
      'Mixer cartridges are often brand-specific and some are 35mm, so the make and model may need confirming before parts are ordered',
  ...
  },
  {
    ...
    pitfalls: [
      ...
      'Cheap customer-supplied taps may be poor quality or unsuitable for UK water pressures',
    ],
  },
  {
    id: 'toilet-cistern',
    ...
    questions: [
      ...
      },
      {
        ...
        askWhen: "water keeps running into the pan or it won't flush properly",
      },
      {
        topic: 'fill valve position',
        question: 'Where does the water pipe join the cistern?',
        options: ['Underneath', 'At the side'],
        askWhen: 'the cistern overflows or is slow to refill',
      },
    ],
    variants: [
      {
  ...
  },
  {
    ...
    variants: [
      ...
      {
        when: 'Leak on 15mm plastic pipe',
        materials: ['Push-fit straight coupler 15mm', 'Pipe insert 15mm'],
      },
      {
        when: 'Leak on 22mm plastic pipe',
        materials: ['Push-fit straight coupler 22mm', 'Pipe insert 22mm'],
      },
      {
      ...
      {
        when: 'Stopcock seized or not shutting off on copper pipe',
        materials: ['Stopcock 15mm'],
      },
      {
        when: 'Stopcock seized or not shutting off on a blue plastic (MDPE) supply pipe',
        materials: [
          'MDPE to copper stopcock 25mm x 15mm',
          'MDPE pipe insert 25mm',
        ],
      },
    ],
    assumptions: [
    ...
    pitfalls: [
      ...
      'Newer homes often have a blue plastic supply pipe, which needs its own type of stopcock and pipe inserts',
    ],
  },
  {
    id: 'outside-tap',
