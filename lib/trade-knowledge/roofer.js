...
export const ROOFER_JOBS = [
  {
    ...
    matches: 'replace missing tiles, slipped tiles, broken roof tiles, missing slates, roof leak after a storm',
    reviewed: false,
    questions: [
      {
        topic: 'roof covering',
    ...
    variants: [
      ...
      {
        when: 'Slate roof',
        materials: ['Natural slate 500mm x 250mm', 'Slate hooks', 'Copper disc rivets'],
      },
      {
        when: 'Rotten battens under the missing tiles',
        materials: ['Treated roofing batten 25mm x 50mm', 'Breathable roofing membrane'],
      },
    ],
    assumptions: [
  ...
  },
  {
    ...
    matches: 'replace a flat roof, garage roof leaking, new flat roof, extension roof, felt roof, rubber roof',
    reviewed: false,
    questions: [
      {
        topic: 'new covering',
    ...
    variants: [
      {
        ...
        materials: ['EPDM rubber membrane 1.2mm', 'EPDM deck adhesive', 'EPDM trim adhesive', 'Flat roof drip trim'],
      },
      {
        when: 'GRP fibreglass roof',
        materials: ['GRP roofing resin', 'Chopped strand mat 450g', 'GRP topcoat', 'GRP drip trim'],
      },
      {
  ...
  },
  {
    ...
    matches: 'gutter needs clearing, guttering, leaking gutter, blocked gutter, new guttering, downpipe',
    reviewed: false,
    questions: [
      {
        topic: 'gutter work',
        question: 'What do the gutters need?',
        options: ['Clearing only', 'Repairing leaking joints', 'Replacing gutter runs'],
      },
      {
    ...
    variants: [
      ...
      },
      {
        ...
        materials: ['Half round gutter union bracket 112mm', 'Gutter joint sealant'],
      },
      {
        when: 'Plastic gutter runs replaced',
        materials: ['Half round gutter 112mm 4m', 'Fascia bracket 112mm', 'Gutter running outlet 112mm', 'Round downpipe 68mm 2.5m'],
      },
    ],
    assumptions: [
  ...
  },
  {
    ...
    matches: 'loose ridge tiles, ridge repointing, dry ridge, rebed ridge tiles, cracked ridge mortar',
    reviewed: false,
    questions: [
      {
        topic: 'ridge problem',
        question: 'What is wrong with the ridge?',
        options: ['Loose ridge tiles', 'Cracked or missing mortar', 'Ridge tiles missing'],
      },
      {
        topic: 'ridge fixing',
  ...
  },
  {
    ...
    matches: 'leak round the chimney, chimney flashing, damp on the chimney breast, lead flashing, chimney repointing',
    reviewed: false,
    questions: [
      {
        topic: 'leak source',
        question: 'Where does the leak seem to come from?',
        options: ['Where the chimney meets the roof', 'The chimney stack itself', 'Leak location unknown'],
      },
      {
    ...
    variants: [
      {
        ...
        materials: ['Code 4 lead flashing 150mm x 3m', 'Lead sealant', 'Lead wedges'],
      },
      {
  ...
  },
  {
    ...
    matches: 'new fascias, replace soffits, rotten fascia boards, roofline replacement, uPVC fascias',
    reviewed: false,
    questions: [
      {
    ...
    variants: [
      {
        when: 'uPVC fascias',
        materials: ['uPVC fascia board 225mm x 5m', 'Stainless steel fascia nails 65mm'],
      },
      {
        when: 'uPVC soffits',
  ...
  },
  {
    ...
    matches: 'roof window, skylight, Velux window, loft window, replace a leaking roof window',
    reviewed: false,
    questions: [
      {
    ...
    variants: [
      {
        ...
        materials: ['Centre pivot roof window 780mm x 980mm', 'Roof window flashing kit for tiles'],
      },
      {
        when: 'Roof window in a slate roof',
        materials: ['Centre pivot roof window 780mm x 980mm', 'Roof window flashing kit for slate'],
      },
      {
        when: 'New opening',
        materials: ['Sawn timber 47mm x 150mm C24', 'Breathable roofing membrane'],
      },
    ],
    assumptions: [
    ...
    exclusions: [
      'Internal plastering, lining and decoration',
      'Blinds',
    ],
    pitfalls: [
